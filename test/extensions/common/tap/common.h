...
public:
  ...
  MOCK_METHOD(void, onHttpRequestHeaders,
              (const Http::RequestHeaderMap& request_headers, MatchStatusVector& statuses), (const));
  ...
  MOCK_METHOD(void, onHttpResponseHeaders,
              (const Http::ResponseHeaderMap& response_headers, MatchStatusVector& statuses), (const));
  MOCK_METHOD(void, onHttpResponseTrailers,
              (const Http::ResponseTrailerMap& response_trailers, MatchStatusVector& statuses), (const));
};
